    ...
    <div class="relative z-20 w-full max-w-md mx-auto p-8 rounded-3xl backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl shadow-black/30 overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-bold text-white mb-1 drop-shadow-lg">SIPRESMA ISI Yogyakarta</h1>
                <p class="text-white/70 text-sm">Sistem Informasi Prestasi Mahasiswa</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                {{-- Tombol Masuk --}}
                <div class="mb-6">
                    <button type="submit" class="w-full justify-center rounded-full bg-blue-600 hover:bg-blue-500 text-white py-3 text-lg font-semibold focus:ring-2 focus:ring-blue-400 transition shadow-md">
                        {{ __('Masuk') }}
                    </button>
                </div>
