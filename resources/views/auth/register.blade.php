<x-guest-layout>
    ...
    <div class="relative z-20 w-full max-w-2xl mx-auto p-6 sm:p-8 rounded-3xl backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl shadow-black/30 overflow-visible">
        ...
        <div class="relative z-10">
            ...
            {{-- FORM --}}
            <form method="POST" action="{{ route('register') }}" id="registerForm" x-data="{ loading: false }" x-on:submit="loading = true">
                @csrf
                    ...
                    <div>
                        <div class="relative group">
                            ...
                            <x-text-input id="password"
                                class="block w-full rounded-2xl backdrop-blur-md bg-white/5 border border-white/10 text-white placeholder-white/40 py-2.5 pl-12 pr-12 text-sm focus:ring-2 focus:ring-white/30 focus:border-white/30 focus:bg-white/10 transition-all"
                ...
                <div class="mb-4">
                    <button type="submit" :disabled="loading"
                        class="w-full rounded-xl bg-blue-600 hover:bg-blue-500 text-white py-3 text-base font-semibold focus:ring-2 focus:ring-blue-400 transition shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed">
