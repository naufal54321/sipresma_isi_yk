        ...
        <div>
            ...
            <div class="relative" x-data="{ show: false }">
                ...
                <input
                    ...
                    class="w-full pl-11 pr-12 py-3 rounded-xl border border-slate-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition">
                
                <button type="button" @click="show = !show" class="absolute right-4 top-3.5 text-slate-400 hover:text-emerald-600 focus:outline-none transition-colors">
