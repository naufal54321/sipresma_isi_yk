...
<script>
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: data.message || 'Prestasi berhasil dihapus',
                            timer: 2000,
                            showConfirmButton: false
                        });
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Gagal!',
                            text: data.message || 'Gagal menghapus prestasi'
                        });
                    }
                })
                .catch(error => {
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                const formData = {
                    ...
                    poin: document.getElementById('add_poin').value.trim(),
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil!',
                            text: data.message || 'Prestasi berhasil ditambahkan',
                            timer: 1500,
                            showConfirmButton: false
    ...
    // ============================================
    // FUNGSI EDIT PRESTASI (FETCH DATA DARI SERVER)
    // ============================================
    function bukaModalEdit(button) {
        ...
        fetch(`/admin/master-prestasi/${id}`, {
            headers: { 
                'Accept': 'application/json',
                'X-CSRF-TOKEN': csrfToken
            }
        ...
        .then(item => {
            ...
            // Buka modal edit dengan data dari server
            Swal.fire({
                ...
                didOpen: () => {
                    ...
                    document.getElementById('edit_poin').value = item.poin || '';
                ...
                preConfirm: () => {
                    ...
                    const formData = {
                        ...
                        poin: document.getElementById('edit_poin').value.trim(),
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            if (row) {
                                ...
                                row.children[3].innerText = formData.poin;
                                ...
                                if (editBtn) {
                                    ...
                                    editBtn.setAttribute('data-poin', formData.poin);
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Berhasil!',
                                text: data.message || 'Prestasi berhasil diperbarui',
                                timer: 1500,
                                showConfirmButton: false
                            });
                        } else {
