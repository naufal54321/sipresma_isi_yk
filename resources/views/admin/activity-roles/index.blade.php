<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-8xl mx-auto py-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Peran Kegiatan</h1>
                    <p class="text-gray-500 mt-1">Kelola data peran dalam kegiatan mahasiswa</p>
                </div>
            </div>

            <div class="bg-white shadow rounded-xl p-4 mb-4 flex flex-col md:flex-row items-center justify-between gap-4">
                <form method="GET" action="{{ route('admin.activity-roles.index') }}"
                    ...
                    <div class="relative w-full md:w-auto flex-shrink-0">
                        <input type="text"
                               ...
                               placeholder="Cari peran kegiatan..."
                    ...
                    <div class="flex gap-2 w-full md:w-auto flex-shrink-0">
                        ...
                        @if(request('search'))
                            <a href="{{ route('admin.activity-roles.index') }}"
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-600">
                        ...
                        <tbody id="tableBody" class="divide-y divide-gray-200">
                            ...
                            <tr id="row-{{ $role->id }}" class="border-b hover:bg-blue-50 transition duration-150">
                                <td class="px-4 py-4 text-center">
                                    {{ ($roles->currentPage() - 1) * $roles->perPage() + $loop->iteration }}
                                </td>
                                <td class="px-4 py-4 font-medium text-gray-800">{{ e($role->name) }}</td>
                                <td class="px-4 py-4 text-center">
    ...
    const baseUrl = '{{ route("admin.activity-roles.index") }}';
        ...
        return `
            <div class="mb-4">
                ...
                <input type="text" id="form_name" value="${data.name || ''}"
                       ...
                       placeholder="Contoh: Peserta, Ketua, Narasumber">
            </div>
            <div class="mb-4">
    ...
    function validasiForm() {
        ...
        if (!name) { Swal.showValidationMessage('Nama peran wajib diisi'); return false; }
        return true;
    }
    ...
    function bukaModalTambah() {
        Swal.fire({
            title: '<h2 class="text-xl font-bold text-gray-800 text-left">Tambah Peran Kegiatan</h2>',
            width: '500px',
            ...
            if (result.isConfirmed) {
                Swal.fire({ icon: 'success', title: 'Berhasil!', text: 'Peran kegiatan berhasil ditambahkan', timer: 2000, showConfirmButton: false })
    ...
    function bukaModalEdit(button) {
        ...
        Swal.fire({
            title: '<h2 class="text-xl font-bold text-gray-800 text-left">Edit Peran Kegiatan</h2>',
            width: '500px',
            ...
            if (result.isConfirmed) {
                Swal.fire({ icon: 'success', title: 'Berhasil!', text: 'Peran kegiatan berhasil diperbarui', timer: 2000, showConfirmButton: false })
                .then(() => location.reload());
            }
        });
    }
