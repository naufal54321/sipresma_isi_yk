<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-8xl mx-auto py-6">
            ...
            <div class="flex items-center justify-between mb-6">
                <div>
                    <h1 class="text-3xl font-bold text-gray-800">Jenis Hasil/Prestasi</h1>
                    <p class="text-gray-500 mt-1">Kelola data jenis hasil dan prestasi mahasiswa</p>
                </div>
            </div>

            <div class="bg-white shadow rounded-xl p-4 mb-4 flex flex-col md:flex-row items-center justify-between gap-4">
                <form method="GET" action="{{ route('admin.achievement-types.index') }}"
                    ...
                    <div class="flex gap-2 w-full md:w-auto flex-shrink-0">
                        ...
                        @if(request('search'))
                            <a href="{{ route('admin.achievement-types.index') }}"
        ...
        return `
            <div class="mb-4">
                ...
                <input type="text" id="form_name" value="${data.name || ''}"
                       ...
                       placeholder="Contoh: Juara I, Finalis, Peserta">
            </div>
            <div class="mb-4">
    ...
    function validasiForm() {
        ...
        if (!name) { Swal.showValidationMessage('Nama jenis prestasi wajib diisi'); return false; }
        return true;
    }
    ...
    function bukaModalTambah() {
        Swal.fire({
            title: '<h2 class="text-xl font-bold text-gray-800 text-left">Tambah Jenis Prestasi</h2>',
            width: '500px',
            ...
            if (result.isConfirmed) {
                Swal.fire({ icon: 'success', title: 'Berhasil!', text: 'Jenis prestasi berhasil ditambahkan', timer: 2000, showConfirmButton: false })
    ...
    function bukaModalEdit(button) {
        ...
        Swal.fire({
            title: '<h2 class="text-xl font-bold text-gray-800 text-left">Edit Jenis Prestasi</h2>',
            width: '500px',
            ...
            if (result.isConfirmed) {
                Swal.fire({ icon: 'success', title: 'Berhasil!', text: 'Jenis prestasi berhasil diperbarui', timer: 2000, showConfirmButton: false })
                .then(() => location.reload());
            }
        });
    }
