            ...
            <form method="GET" action="{{ route('dosen.spk.index') }}" class="flex flex-col md:flex-row gap-4 items-end">
                ...
                <div class="flex gap-2 w-full md:w-auto">
                    ...
                    @if(request('search') || request('tahun') || request('status'))
                        <a href="{{ route('dosen.spk.index') }}" class="bg-gray-100 hover:bg-gray-200 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-semibold transition text-center flex items-center justify-center">
                            Reset
                        </a>
                    @endif
                </div>
