<nav class="fixed top-0 left-0 z-40 w-64 h-screen bg-[#16233b] text-white shadow-xl">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M6 6.878V6a2.25 2.25 0 0 1 2.25-2.25h7.5A2.25 2.25 0 0 1 18 6v.878m-12 0c.235-.083.487-.128.75-.128h10.5c.263 0 .515.045.75.128m-12 0A2.25 2.25 0 0 0 4.5 9v.878m13.5-3A2.25 2.25 0 0 1 19.5 9v.878m0 0a2.246 2.246 0 0 0-.75-.128H5.25c-.263 0-.515.045-.75.128m15 0A2.25 2.25 0 0 1 21 12v6a2.25 2.25 0 0 1-2.25 2.25H5.25A2.25 2.25 0 0 1 3 18v-6c0-.98.626-1.813 1.5-2.122" />
    ...
    <span>Master Kegiatan</span>
        ...
        <div x-data="{ open: {{ request()->routeIs('dosen.kegiatan.*', 'dosen.spk.*') ? 'true' : 'false' }} }">
            <button @click="open = !open"
                    class="flex items-center justify-between w-full px-6 py-3 transition border-l-4 {{ request()->routeIs('dosen.kegiatan.*', 'dosen.spk.*') ? 'bg-gray-900 border-yellow-500 text-white' : 'border-transparent text-gray-400 hover:bg-gray-800 hover:text-white' }}">
            ...
            <div x-show="open" class="bg-[#111b2e] py-2">
                <a href="{{ route('dosen.kegiatan.index') }}"
                   class="flex items-center gap-3 pl-14 pr-6 py-2 transition {{ request()->routeIs('dosen.kegiatan.*') ? 'text-white font-semibold' : 'text-gray-400 hover:text-white' }}">
