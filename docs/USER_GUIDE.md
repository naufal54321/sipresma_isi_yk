...
**PRATAMA** (Prestasi dan Talenta Mahasiswa) adalah sistem informasi berbasis web untuk mengelola pencatatan prestasi mahasiswa di **Institut Seni Indonesia Yogyakarta**. Sistem ini memungkinkan:
...
- **Chart Prestasi Berdasarkan Tingkat:** Universitas, Regional, Nasional, Internasional
...
| Judul Karya/Inovasi/Riset/Prestasi | ✅ Wajib |
...
- Nama file tidak mengandung karakter khusial
...
### 10.9 Bagaimana cara melihat statistik publik?

Statistik publik tersedia di halaman beranda (`/`) dan halaman statistik (`/statistik`) tanpa perlu login.

### 10.10 Saya adalah dosen, bagaimana cara melihat mahasiswa bimbingan?

Di sidebar, klik **"Mahasiswa Bimbingan"**. Anda akan melihat daftar mahasiswa yang memiliki `dosen_pembimbing_id` yang sama dengan akun Anda.
